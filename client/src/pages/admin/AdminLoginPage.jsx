...
function AdminLoginPage() {
  ...
  const [email, setEmail] = useState('admin@viec3mien.vn');
  ...
  useEffect(() => {
    document.title = 'Đăng nhập quản trị | Việc 3 Miền';
  }, []);
  ...
  return (
    <main className="admin-shell grid min-h-screen place-items-center px-4 py-10">
      <section className="w-full max-w-md rounded-[28px] border border-white/70 bg-white/95 p-6 shadow-panel">
        <p className="text-xs font-bold uppercase tracking-[0.3em] text-ember-600">Việc 3 Miền</p>
